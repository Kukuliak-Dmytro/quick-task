...
export default function Home() {
  return (
    <div
      ...
      <main
        className="flex min-h-screen w-full max-w-4xl flex-col items-center
          justify-start py-16 px-8 bg-white dark:bg-black">
        <div className="w-full max-w-4xl space-y-12">
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-primary flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-secondary flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-accent flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-muted flex items-center
                    justify-center">
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-background border border-border
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-card border border-border flex
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-popover border border-border
                    flex items-center justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-input border border-border flex
                    items-center justify-center">
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-chart-1 flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-chart-2 flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-chart-3 flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-chart-4 flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-chart-5 flex items-center
                    justify-center">
          ...
          <section className="space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-sidebar flex items-center
                    justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-sidebar-primary flex
                    items-center justify-center">
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-sidebar-accent flex items-center
                    justify-center">
                ...
                <Button
                  variant="outline"
                  className="w-full text-sidebar-accent-foreground
              ...
              <div className="space-y-2">
                <div
                  className="h-16 rounded-lg bg-sidebar-border border
